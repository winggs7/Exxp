...
public class InputManager {	
	...
	public void processKeyPressed(int keyCode) {
		...
		if(keyCode==KeyEvent.VK_ENTER) {
			if(gameWorld.getState() == gameWorld.BEGIN) {
				gameWorld.setState(gameWorld.STARTGAME);
				gameWorld.player.setState(gameWorld.player.ALIVE);
			}
			else if(gameWorld.getState() == gameWorld.OVER) {
				gameWorld.setState(gameWorld.BEGIN);
			}
